...
import Leadertab from '../../Features/Pages/student/leaderboard';
...
const StudentPage: React.FC = () => {
    ...
    const navItems = [
        { label: "Assigned", icon: <PeopleIcon />, component: <Assignmentstab /> },
        { label: "Leader Board", icon: <SportsKabaddiIcon />, component: <Leadertab /> },
        { label: "AI Guide", icon: <AssessmentIcon />, component: <Recommendationtab /> }
    ];
